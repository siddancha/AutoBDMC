...
namespace clustering_hp_model_namespace {
...
class clustering_hp_model : public prob_grad {
private:
    int N;
    int D;
    int K;
    ...
    vector_d ones;
public:
    clustering_hp_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "clustering_hp_model_namespace::clustering_hp_model";
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("sigma_1")))
            throw std::runtime_error("variable sigma_1 missing");
        vals_r__ = context__.vals_r("sigma_1");
        pos__ = 0U;
        context__.validate_dims("initialization", "sigma_1", "double", context__.to_vec());
        double sigma_1(0);
        sigma_1 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,sigma_1);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable sigma_1: ") + e.what());
        }

        if (!(context__.contains_r("sigma_2")))
            throw std::runtime_error("variable sigma_2 missing");
        vals_r__ = context__.vals_r("sigma_2");
        pos__ = 0U;
        context__.validate_dims("initialization", "sigma_2", "double", context__.to_vec());
        double sigma_2(0);
        sigma_2 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,sigma_2);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable sigma_2: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        T__ sigma_1;
        (void) sigma_1;   // dummy to suppress unused var warning
        if (jacobian__)
            sigma_1 = in__.scalar_lb_constrain(0,lp__);
        else
            sigma_1 = in__.scalar_lb_constrain(0);
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            lp_accum_params__.add(cauchy_log<propto__>(sigma_1, 0, 5));
            current_statement_begin__ = 35;
            lp_accum_params__.add(cauchy_log<propto__>(sigma_2, 0, 5));
            current_statement_begin__ = 38;
            for (int k = 1; k <= K; ++k) {
                current_statement_begin__ = 39;
                for (int d = 1; d <= D; ++d) {
                    current_statement_begin__ = 40;
                    lp_accum_params__.add(normal_log<propto__>(get_base1(get_base1(mu,k,"mu",1),d,"mu",2), 0, sigma_1));
                }
            }
            current_statement_begin__ = 41;
            lp_accum_params__.add(normal_log<propto__>(sigma, 0, sigma_2));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void exact_sample(RNG& base_rng__,
        ...
        stan::math::fill(sigma_1,DUMMY_VAR__);
        ...
        try {
            current_statement_begin__ = 34;
            stan::math::assign(sigma_1, cauchy_rng(0, 5, base_rng__));
            current_statement_begin__ = 35;
            stan::math::assign(sigma_2, cauchy_rng(0, 5, base_rng__));
            current_statement_begin__ = 38;
            for (int k = 1; k <= K; ++k) {
                current_statement_begin__ = 39;
                for (int d = 1; d <= D; ++d) {
                    current_statement_begin__ = 40;
                    stan::math::assign(get_base1_lhs(get_base1_lhs(mu,k,"mu",1),d,"mu",2), normal_rng(0, sigma_1, base_rng__));
                }
            }
            current_statement_begin__ = 41;
            stan::math::assign(sigma, normal_rng(0, sigma_2, base_rng__));
            current_statement_begin__ = 42;
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        vars_param__.push_back(sigma_1);
        vars_param__.push_back(sigma_2);
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "clustering_hp_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        ...
        double sigma_1 = in__.scalar_lb_constrain(0);
...
typedef clustering_hp_model_namespace::clustering_hp_model stan_model;
