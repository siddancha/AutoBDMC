...
def main():
	...
	plt.errorbar(stan_uc_dict["aisSteps"], stan_uc_dict["aisMeans"], np.array([stan_uc_dict["aisLowers"], stan_uc_dict["aisUppers"]]), c='red', label='Stan (uncollapsed)')
	...
	plt.errorbar(stan_c_dict["aisSteps"], stan_c_dict["aisMeans"], np.array([stan_c_dict["aisLowers"], stan_c_dict["aisUppers"]]), c='maroon', label='Stan (collapsed)')
	plt.errorbar(stan_c_dict["raisSteps"], stan_c_dict["raisMeans"], np.array([stan_c_dict["raisLowers"], stan_c_dict["raisUppers"]]), c='maroon')

	plt.errorbar(webppl_uc_dict["aisSteps"], webppl_uc_dict["aisMeans"], np.array([webppl_uc_dict["aisLowers"], webppl_uc_dict["aisUppers"]]), c='dodgerblue', label='WebPPL (uncollapsed)')
	...
	plt.errorbar(webppl_c_dict["aisSteps"], webppl_c_dict["aisMeans"], np.array([webppl_c_dict["aisLowers"], webppl_c_dict["aisUppers"]]), c='darkblue', label='WebPPL (collapsed)')
	...
	ucDivStanLowers = stan_uc_dict["raisLowers"] + stan_uc_dict["aisUppers"]
	ucDivStanUppers = stan_uc_dict["raisUppers"] + stan_uc_dict["aisLowers"]
	plt.errorbar(ucDivStanSteps, ucDivStanMeans, np.array([ucDivStanLowers, ucDivStanUppers]), c='red', label='Stan (uncollapsed)')
	...
	cDivStanLowers = stan_c_dict["raisLowers"] + stan_c_dict["aisUppers"]
	cDivStanUppers = stan_c_dict["raisUppers"] + stan_c_dict["aisLowers"]
	plt.errorbar(cDivStanSteps, cDivStanMeans, np.array([cDivStanLowers, cDivStanUppers]), c='maroon', label='Stan (collapsed)')
	...
	ucDivWebpplLowers = webppl_uc_dict["raisLowers"] + webppl_uc_dict["aisUppers"]
	ucDivWebpplUppers = webppl_uc_dict["raisUppers"] + webppl_uc_dict["aisLowers"]
	plt.errorbar(ucDivWebpplSteps, ucDivWebpplMeans, np.array([ucDivWebpplLowers, ucDivWebpplUppers]), c='dodgerblue', label='WebPPL (uncollapsed)')
	...
	cDivWebpplLowers = webppl_c_dict["raisLowers"] + webppl_c_dict["aisUppers"]
	cDivWebpplUppers = webppl_c_dict["raisUppers"] + webppl_c_dict["aisLowers"]
	plt.errorbar(cDivWebpplSteps, cDivWebpplMeans, np.array([cDivWebpplLowers, cDivWebpplUppers]), c='darkblue', label='WebPPL (collapsed)')
